...
export default function NewTaskPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const session = await createSession({ task_id: taskId, skillId, model: modelId, topic: prompt, platform, accountId: selectedAccountId, novel_name: novelName.trim() || undefined })
